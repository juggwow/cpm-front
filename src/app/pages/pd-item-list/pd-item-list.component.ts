...
@Component({
  selector: 'app-pd-item-list',
  standalone: true,
  templateUrl: './pd-item-list.component.html',
  styleUrls: ['./pd-item-list.component.scss'],
...
export class PdItemListComponent implements OnInit{
